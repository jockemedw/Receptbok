...
> Genererad av `scripts/audit-ingredients.mjs`. Källa: fil: docs/recipe-backup-20260607.json.

## Sammanfattning

- **Recept:** 262
- **Ingrediensrader:** 3791
- **Rader med problem (P0–P2):** 725
...
| **P2** | 657 | Ej pris-matchbart namn, brus eller kosmetiskt format |

## Per problemklass

| Klass | Antal rader |
|---|---|
| C1 okänt namn (ej canon) | 399 |
...
- **Icke-canon-namn (unika):** 332 — matchar inga Willys-erbjudanden, slås ihop svagt.
...
- `kycklingbröst utan ben och skinn, tärnad (450 g)`  — **P1** (C3 flera ingredienser/rad; C4 beskrivande brus)

### #163 — Apelsin- och basilikakyckling med kokosnötris

- `kycklingbröst utan ben och skinn (450 g, tärnad i munsbitar)`  — **P1** (C3 flera ingredienser/rad; C4 beskrivande brus)
...
- `kokosflingor, gärna snabbt rostade i torr stekpanna`  — **P1** (C2 saknad mängd)
