...
## Öppna utredningar
**App-analys-backlog (`docs/app-analys-backlog.md` — statusbanner uppdaterad Session 104):** hela **P0 avklarad** — #1/#4/#8/#9/#26/#27 gjordes redan i Session 102-nattjobbet (backlogfilen listade dem felaktigt som öppna → rättat Session 104), #3 klar i Session 103, #2 kod klar (väntar på `ALERT_WEBHOOK`-env). #25 delvis (escapers→utils klart; `fmtKr`/spegelkod kräver display-/plan-vägs-beslut). Prioriterade nästa steg: **#5–#7** (Willys-cookies ur secret gist → Supabase+RLS, JWT-baserad household-härledning, multi-user dispatch — Fas 5-blockerare), **#10–#11** (custom-days-race, Supabase free-tier-paus). Produktspår: **#12 portionsskalning** + **#15 Ikväll-snabbredigerare** (agenternas två "bygg näst"). Hela listan med väg framåt i backlog-filen.
