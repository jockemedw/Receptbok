...
lines.push('');
lines.push('```bash');
lines.push('# Granska först utan att skriva:');
lines.push('SUPABASE_URL=… SUPABASE_SERVICE_ROLE_KEY=… node scripts/dish-scrape/promote.mjs --dry-run');
lines.push('# Infoga sedan i Supabase (recepten blir live direkt — ingen git-commit behövs):');
lines.push('SUPABASE_URL=… SUPABASE_SERVICE_ROLE_KEY=… node scripts/dish-scrape/promote.mjs');
lines.push('```');
lines.push('');
